...
copyright = u"voraus robotik GmbH"
...
latex_documents = [
    ("index", "{{ cookiecutter.import_name }}.tex", u"{{ cookiecutter.project_name }} Documentation", u"{{ cookiecutter.full_name }}", "manual"),
]
...
texinfo_documents = [
  ("index", "{{ cookiecutter.import_name }}", u"{{ cookiecutter.project_name }} Documentation",
   u"{{ cookiecutter.full_name }}", "{{ cookiecutter.import_name }}", "One line description of project.",
   "Miscellaneous"),
]
